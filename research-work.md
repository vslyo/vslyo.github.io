...
Lately, my work has been on quantum foundations and moving towards quantum foundational issues intersecting with special relativity. The work I've been doing over the years:
* [Correlation as a Resource](correlation-poster.pdf): Quantum measurment involves the environment; assuming unitary quantum mechanics and some other natural statement constrians the initial state of the environment that allows for successful measurmeent. Also available as a [talk handout](correlation-talk.pdf).
* [When Everett observes Greenberger, Horne, and Zeilinger meet Wigner's friend](everett-ghz-poster.pdf): Can quantum mechanics and special relativity coexist in the context of the Wigner friend thought experiment? A [recent paradox](https://arxiv.org/abs/1811.02442).
* [Born Rule in Unitary Quantum Mechanics](born-rule-poster.pdf): A derivation of the Born rule following [Zurek's work](https://arxiv.org/abs/quant-ph/0405161).
